...
- [[frontend/components-deep]] — Deep docs for analytics, layout, and route-based triage workspace components (props, state, effects, behavior).
- [[frontend/validator-triage-shortcuts]] — safe keyboard shortcut reference for route-based civilian report triage actions and click-only commits.
