...
sources: [raw/codebase/codebase-snapshot-2026-05-14.md, src/frontend/src/app/contributor/page.tsx, src/frontend/src/components/LayoutShell.tsx, src/frontend/src/components/PublicHeader.tsx, src/frontend/src/components/public/PublicThemeProvider.tsx, src/keycloak/themes/wims-bfp/login/template.ftl]
status: draft
---
...
|| `/dashboard/validator/perimeter-draw` | `dashboard/validator/perimeter-draw/page.tsx` | Online NATIONAL_VALIDATOR/SYSTEM_ADMIN workspace. Loads a verified incident by ID, uses the incident's stored jurisdiction metadata, and saves a manually drawn GeoJSON polygon through the perimeter API; client area remains preview-only. |
