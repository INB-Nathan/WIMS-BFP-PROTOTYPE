...
@pytest.mark.unit
@pytest.mark.parametrize("param_key,kwarg,value,base_kwargs", [
    ...
    ("gen_cat",   "general_category",   "STRUCTURAL", {"incident_date": "2026-05-09", "lat": 14.5, "lon": 121.0}),
    ("type_code", "incident_type_code", "APT",        {"incident_date": "2026-05-09", "lat": 14.5, "lon": 121.0}),
    ...
    ("city",     "city_municipality",  "Quezon City", {"incident_date": "2026-05-09", "lat": 14.5, "lon": 121.0}),
    ("province", "province_district",  "NCR",         {"incident_date": "2026-05-09", "lat": 14.5, "lon": 121.0}),
])
