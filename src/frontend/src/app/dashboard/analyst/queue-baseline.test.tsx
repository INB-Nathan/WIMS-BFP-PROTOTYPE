...
vi.mock('@/lib/api', () => ({
  ...
  fetchAnalyticsFilterOptionsOfflineAware: async (field: string, filters: object) => ({ response: await mockFetchAnalyticsFilterOptions(field, filters), fromCache: false }),
