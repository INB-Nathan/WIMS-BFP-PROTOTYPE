    ...
    <div className="bg-white p-6 rounded-lg shadow-md max-w-4xl mx-auto space-y-6">
      ...
      >
        ...
        <section id="structural-sec-response" className="scroll-mt-24 space-y-4 border-b pb-6">
          <h3 className="font-bold text-lg border-l-4 pl-2" style={{ color: '#1A3263', borderLeftColor: '#1A3263' }}>A. Response Details</h3>
        ...
        <section id="structural-sec-class" className="scroll-mt-24 space-y-4 border-b pb-6">
          <h3 className="font-bold text-lg border-l-4 pl-2" style={{ color: '#1A3263', borderLeftColor: '#1A3263' }}>B. Nature and Classification of Involved</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <section className="space-y-4 border-b pb-6">
          <h3 className="font-bold text-lg border-l-4 pl-2" style={{ color: '#1A3263', borderLeftColor: '#1A3263' }}>G. Other BFP Personnel and Significant Personalities at the Scene</h3>
        ...
        <section id="structural-sec-narrative" className="scroll-mt-24 space-y-4 border-b pb-6">
          <h3 className="font-bold text-lg border-l-4 pl-2" style={{ color: '#1A3263', borderLeftColor: '#1A3263' }}>H. Narrative Content (In Chronological Order)</h3>
          <textarea
        ...
        <section id="structural-sec-recommendations" className="scroll-mt-24 space-y-4 border-b pb-6">
          <h3 className="font-bold text-lg border-l-4 pl-2" style={{ color: '#1A3263', borderLeftColor: '#1A3263' }}>J. Recommendations</h3>
        ...
        <section id="structural-sec-disposition" className="scroll-mt-24 space-y-4">
          <h3 className="font-bold text-lg border-l-4 pl-2" style={{ color: '#1A3263', borderLeftColor: '#1A3263' }}>K. Disposition</h3>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <button
            ...
            className="flex-1 text-white py-3 rounded font-bold disabled:opacity-50 flex justify-center items-center gap-2 shadow-lg" style={{ backgroundColor: '#1A3263' }}
          >
